...
pub fn cuisine_vocabulary() -> &'static [CuisineEntry] {
    static VOCAB: &[CuisineEntry] = &[
        CuisineEntry {
            ...
            instruction_keywords: &["al dente", "sauté in olive oil"],
        },
        CuisineEntry {
            label: "Mexican",
            title_keywords: &[
            ...
            instruction_keywords: &["char", "roast peppers"],
        },
        CuisineEntry {
            label: "Japanese",
            title_keywords: &[
                "japanese", "sushi", "ramen", "teriyaki", "tempura", "udon", "soba", "miso",
                "onigiri", "gyoza", "katsu", "donburi",
            ],
            ingredient_keywords: &[
                "soy sauce",
                "mirin",
            ...
            instruction_keywords: &["roll sushi", "deep-fry"],
        },
        CuisineEntry {
            label: "Chinese",
            title_keywords: &[
            ...
            instruction_keywords: &["wok", "stir-fry", "steam"],
        },
        CuisineEntry {
            label: "Thai",
            title_keywords: &[
            ...
            instruction_keywords: &["wok", "stir-fry", "pound in mortar"],
        },
        CuisineEntry {
            label: "Indian",
            title_keywords: &[
            ...
            instruction_keywords: &["temper spices", "tandoor"],
        },
        CuisineEntry {
            label: "French",
            title_keywords: &[
            ...
            instruction_keywords: &["flambé", "deglaze", "julienne"],
        },
        CuisineEntry {
            label: "Greek",
            title_keywords: &[
            ...
            instruction_keywords: &["grill on skewers"],
        },
        CuisineEntry {
            label: "Mediterranean",
            title_keywords: &[
            ...
            instruction_keywords: &["drizzle olive oil"],
        },
        CuisineEntry {
            label: "Korean",
            title_keywords: &[
            ...
            instruction_keywords: &["ferment", "grill at table"],
        },
        CuisineEntry {
            label: "Vietnamese",
            title_keywords: &[
            ...
            instruction_keywords: &["simmer broth"],
        },
        CuisineEntry {
            label: "American",
            title_keywords: &[
            ...
            instruction_keywords: &["grill", "smoke"],
        },
        CuisineEntry {
            label: "Southern",
            title_keywords: &[
            ...
            instruction_keywords: &["deep-fry", "slow cook"],
        },
        CuisineEntry {
            label: "Cajun/Creole",
            title_keywords: &[
            ...
            instruction_keywords: &["make roux", "blacken"],
        },
        CuisineEntry {
            label: "Caribbean",
            title_keywords: &[
            ...
            instruction_keywords: &["jerk", "marinate overnight"],
        },
        CuisineEntry {
            ...
            instruction_keywords: &["roast on spit"],
        },
        CuisineEntry {
            label: "Ethiopian",
            title_keywords: &["ethiopian", "injera", "doro wat", "kitfo", "tibs", "shiro"],
            ingredient_keywords: &[
                "berbere",
                "niter kibbeh",
                "teff",
            ...
            instruction_keywords: &["simmer stew"],
        },
        CuisineEntry {
            label: "Moroccan",
            title_keywords: &[
                "moroccan", "tagine", "couscous", "harira", "bastilla", "rfissa",
            ],
            ingredient_keywords: &[
                "ras el hanout",
                "preserved lemon",
            ...
            instruction_keywords: &["slow cook in tagine"],
        },
        CuisineEntry {
            label: "Turkish",
            title_keywords: &[
                "turkish", "kebab", "pide", "lahmacun", "manti", "börek", "baklava", "köfte",
            ],
            ingredient_keywords: &[
                "sumac",
                "pomegranate",
        ...
        CuisineEntry {
            ...
            instruction_keywords: &["sear in paella pan"],
        },
        CuisineEntry {
            label: "Portuguese",
            title_keywords: &[
            ...
            instruction_keywords: &["salt cure", "grill over charcoal"],
        },
        CuisineEntry {
            label: "German",
            title_keywords: &[
            ...
            instruction_keywords: &["bread and fry", "braise"],
        },
        CuisineEntry {
            label: "British",
            title_keywords: &[
            ...
            instruction_keywords: &["roast", "batter and fry"],
        },
        CuisineEntry {
            label: "Irish",
            title_keywords: &[
            ...
            ingredient_keywords: &[
                "potato", "cabbage", "lamb", "stout", "butter", "oats", "leek",
            ],
            instruction_keywords: &["slow simmer"],
        },
        CuisineEntry {
            label: "Scandinavian",
            title_keywords: &[
            ...
            instruction_keywords: &["cure", "pickle"],
        },
        CuisineEntry {
            label: "Russian",
            title_keywords: &[
            ...
            instruction_keywords: &["simmer borscht"],
        },
        CuisineEntry {
            label: "Polish",
            title_keywords: &[
            ...
            instruction_keywords: &["boil then fry"],
        },
        CuisineEntry {
            label: "Brazilian",
            title_keywords: &[
            ...
            instruction_keywords: &["grill on skewers", "slow cook beans"],
        },
        CuisineEntry {
            label: "Peruvian",
            title_keywords: &[
            ...
            instruction_keywords: &["cure in lime juice"],
        },
        CuisineEntry {
            label: "Filipino",
            title_keywords: &[
            ...
            instruction_keywords: &["braise in vinegar"],
        },
        CuisineEntry {
            label: "Indonesian",
            title_keywords: &[
            ...
            instruction_keywords: &["grind spice paste"],
        },
        CuisineEntry {
            label: "Malaysian",
            title_keywords: &[
            ...
            instruction_keywords: &["stir-fry on high heat"],
        },
        CuisineEntry {
            label: "Hawaiian",
            title_keywords: &[
            ...
            instruction_keywords: &["smoke in pit"],
        },
        CuisineEntry {
            label: "Tex-Mex",
            title_keywords: &[
            ...
            instruction_keywords: &["smother in cheese"],
        },
    ];
    VOCAB
}
...
pub fn course_vocabulary() -> &'static [CourseEntry] {
    static VOCAB: &[CourseEntry] = &[
        CourseEntry {
            ...
            contextual_keywords: &["overnight", "morning", "sunrise", "brunch"],
        },
        CourseEntry {
            label: "brunch",
            title_keywords: &["brunch", "eggs benedict", "mimosa", "quiche"],
            ingredient_keywords: &["eggs", "hollandaise", "smoked salmon", "champagne"],
            contextual_keywords: &["weekend", "late morning", "mid-morning"],
        },
        CourseEntry {
            label: "lunch",
            title_keywords: &["lunch", "sandwich", "wrap", "panini", "sub"],
            ingredient_keywords: &["bread", "deli meat", "lettuce", "tomato"],
            contextual_keywords: &["midday", "noon", "lunchbox", "packed lunch"],
        },
        CourseEntry {
            label: "dinner",
            title_keywords: &[
            ...
            contextual_keywords: &["evening", "tonight", "weeknight", "family meal"],
        },
        CourseEntry {
            label: "appetizer",
            title_keywords: &[
            ...
            ingredient_keywords: &["crackers", "cream cheese", "phyllo", "puff pastry"],
            contextual_keywords: &["before dinner", "party", "finger food", "bite-size"],
        },
        CourseEntry {
            label: "side dish",
            title_keywords: &[
            ...
            ingredient_keywords: &["potato", "rice", "vegetables", "beans"],
            contextual_keywords: &["accompaniment", "alongside", "on the side", "goes with"],
        },
        CourseEntry {
            label: "main course",
            title_keywords: &[
            ...
            ingredient_keywords: &["whole chicken", "beef roast", "pork loin", "fish fillet"],
            contextual_keywords: &["main event", "centerpiece", "hearty"],
        },
        CourseEntry {
            label: "dessert",
            title_keywords: &[
            ...
            contextual_keywords: &["sweet", "bake", "decorate", "frosting", "icing"],
        },
        CourseEntry {
            label: "snack",
            title_keywords: &[
            ...
            ingredient_keywords: &["nuts", "dried fruit", "seeds", "chocolate chips", "oats"],
            contextual_keywords: &["quick bite", "on the go", "between meals", "portable"],
        },
        CourseEntry {
            label: "beverage",
            title_keywords: &[
            ...
            contextual_keywords: &["sip", "pour", "blend", "shake", "stir"],
        },
        CourseEntry {
            label: "soup",
            title_keywords: &[
            ...
            ingredient_keywords: &["broth", "stock", "bouillon", "celery", "carrot", "onion"],
            contextual_keywords: &["simmer", "ladle", "bowl", "warm"],
        },
        CourseEntry {
            label: "salad",
            title_keywords: &[
            ...
            contextual_keywords: &["toss", "fresh", "crisp", "chop"],
        },
    ];
    VOCAB
}
...
pub fn diet_vocabulary() -> &'static [DietDefinition] {
    static VOCAB: &[DietDefinition] = &[
        DietDefinition {
            label: "vegan",
            excluded_flags: &[
                DietaryFlag::ContainsMeat,
                DietaryFlag::ContainsPoultry,
                DietaryFlag::ContainsFish,
                DietaryFlag::ContainsDairy,
                DietaryFlag::ContainsEggs,
            ],
        },
        DietDefinition {
            label: "vegetarian",
        ...
        DietDefinition {
            label: "pescatarian",
            excluded_flags: &[DietaryFlag::ContainsMeat, DietaryFlag::ContainsPoultry],
        },
        DietDefinition {
            label: "gluten-free",
            excluded_flags: &[DietaryFlag::ContainsGluten],
        },
        DietDefinition {
            label: "dairy-free",
            excluded_flags: &[DietaryFlag::ContainsDairy],
        },
        DietDefinition {
            label: "nut-free",
            excluded_flags: &[DietaryFlag::ContainsNuts],
        },
        DietDefinition {
            label: "egg-free",
            excluded_flags: &[DietaryFlag::ContainsEggs],
        },
        DietDefinition {
            label: "soy-free",
            excluded_flags: &[DietaryFlag::ContainsSoy],
        },
        DietDefinition {
            label: "keto",
            excluded_flags: &[DietaryFlag::HighCarb, DietaryFlag::ContainsSugar],
        },
        DietDefinition {
            label: "paleo",
            excluded_flags: &[
                DietaryFlag::ContainsGluten,
                DietaryFlag::ContainsDairy,
                DietaryFlag::ContainsSoy,
                DietaryFlag::ContainsSugar,
            ],
        },
        DietDefinition {
            label: "whole30",
        ...
        DietDefinition {
            label: "low-carb",
            excluded_flags: &[DietaryFlag::HighCarb],
        },
        DietDefinition {
            label: "low-fat",
            excluded_flags: &[DietaryFlag::HighFat],
        },
        DietDefinition {
            label: "sugar-free",
            excluded_flags: &[DietaryFlag::ContainsSugar],
        },
        DietDefinition {
            label: "Mediterranean diet",
            excluded_flags: &[DietaryFlag::HighFat, DietaryFlag::ContainsSugar],
        },
    ];
    VOCAB
}
