...
- Rust 1.77+ (stable toolchain) + auri 2.1.0, serde 1.0, thiserror 2, rusqlite 0.38 (NEW — `bundled` feature) (005-persistent-state)
...
## Recent Changes
- 005-persistent-state: Added Rust 1.77+ (stable toolchain) + auri 2.1.0, serde 1.0, thiserror 2, rusqlite 0.38 (NEW — `bundled` feature)
